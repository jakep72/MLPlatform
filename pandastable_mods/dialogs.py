...
class QueryDialog(Frame):
    ...
    def setup(self):
        ...
        addButton(f, 'add filter', self.addFilter, images.add(),
                  'add filter', side=LEFT)
    ...
    def query(self, evt=None):
        ...
        self.filtdf = filtdf = df.drop(delcols,axis = 1)
        
        self.filtdf = filtdf = filtdf[mask]
        ...
        QueryDialog.hello.append(filtdf)
    ...
    def dellist(self, delcol=[]):
        """Apply the widget based filters to delete selcted columns"""
